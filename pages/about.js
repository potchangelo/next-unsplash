            ...
            <section className="section">
                <div className={style.main}>
                    ...
                    <div className="content mb-6">
                        ...
                        <ul>
                            <li><a href="https://nextjs.org/" target="_blank">Next.js (React Framework)</a></li>
                            <li><a href="https://react-query.tanstack.com/" target="_blank">React Query (Data Fetching)</a></li>
                            <li><a href="https://github.com/feathericons/react-feather" target="_blank">React Feather (Icons)</a></li>
                            <li><a href="https://bulma.io/" target="_blank">Bulma (CSS Frameworks)</a></li>
                            <li><a href="https://github.com/potchangelo/express-unsplash" target="_blank">Express Unsplash-Cloned API by Zinglecode</a></li>
                        </ul>
                    </div>
                    <div className="content mb-6">
